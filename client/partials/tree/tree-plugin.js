...
(function($) {
    ...
    $.widget('ui.tree', {
        ...
        options: {
            ...
            "state": { "key": "tree1", "events": "activate_node.jstree" },
        ...
        _setOption: function(key, value) {
            ...
            if (key === "data") {
                ...
                self.element.jstree(true).save_state();
                self.element.jstree(true).refresh();
                self.element.jstree(true).restore_state();
            }
